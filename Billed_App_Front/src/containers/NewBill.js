...
export default class NewBill {
  ...
  handleChangeFile = e => {
    ...
    // add regex to test format
    const regexFormat = new RegExp(`(jpg|jpeg|png)`, "i" )
    if (!regexFormat.test(file.name)){
      console.log(file.name)
      //if not at corrected format throw error
      alert("file extension is not supported ! Use .jpg, .jpeg or .png ")
      e.target.value = "";
    }
